...
public class DynamicBeat extends JFrame {
	...
	private Image titleImage = new ImageIcon(Main.class.getResource("../images/Human Title Image.png")).getImage();
	private Image selectedImage = new ImageIcon(Main.class.getResource("../images/Human Start image.png")).getImage();
